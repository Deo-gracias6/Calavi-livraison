...
const LoginPage = () => {
  ...
  useEffect(() => {
    document.title = 'Connexion | CALAVI COURSES';
    if (isAuthenticated) {
      navigate('/');
    }
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          <div className="rounded-md shadow-sm space-y-4">
            <div>
              ...
              <input
                ...
                className="appearance-none rounded-md relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 focus:outline-none focus:ring-primary-500 focus:border-primary-500 focus:z-10 sm:text-xs text-xs"
          ...
          {/* <div className="mt-4 text-center text-xs">
            <p className="text-gray-600">
              Pour les tests, utilisez: <br/>
              <span className="font-medium">Email: user@example.com</span><br/>
              <span className="font-medium">Mot de passe: password123</span>
            </p>
          </div> */}
        </form>
      </div>
